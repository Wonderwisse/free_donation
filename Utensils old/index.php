...
<body>
    ...
    <div class="stove.png" >
        ...
        <div class="row" style="top:50px;">
            <div class="col-lg-12">
                <h3 class="center" align="center" style="color:green;"></h3>
<hr><br>
				<h3 class="center" align="center" style="color:green;"> Kitchen Utensil Distributions</h3>

   <hr>
   <div id="get_distributions"></div>
