...
<hr>			
		...
		<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							<td>Receiver Name : <input type="text" name="txtreceiver" id="txtreceiver" class="form-control" required>
							<td>Mobile : <input type="number" name="txtmobile" id="txtmobile" class="form-control" required>
							
						</tr>
						<tr>
							<td>Area Name : <input type="text" name="txtarea" id="txtarea" class="form-control" required>
